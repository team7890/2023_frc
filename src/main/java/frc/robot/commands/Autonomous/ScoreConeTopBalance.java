...
public class ScoreConeTopBalance extends SequentialCommandGroup {
  ...
  public ScoreConeTopBalance(Arm_subsystem objArm, Forearm_subsystem objForearm, Wrist_subsystem objWrist, Grabber_subsystem objGrabber, Swerve_subsystem objSwerve) {

...
public class ScoreConeTopMoveLong extends SequentialCommandGroup {
  ...
  public ScoreConeTopMoveLong(Arm_subsystem objArm, Forearm_subsystem objForearm, Wrist_subsystem objWrist, Grabber_subsystem objGrabber, Swerve_subsystem objSwerve) {

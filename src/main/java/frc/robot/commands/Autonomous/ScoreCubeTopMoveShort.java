...
public class ScoreCubeTopMoveShort extends SequentialCommandGroup {
  ...
  public ScoreCubeTopMoveShort(Arm_subsystem objArm, Forearm_subsystem objForearm, Wrist_subsystem objWrist, Grabber_subsystem objGrabber, Swerve_subsystem objSwerve) {
